...
public class Print
{
   ...
   public static void caught(Throwable e)
   {
   ...
   public static void XP_(String str)
   {
   ...
   public static void EP_(String str)
   {
      System.out.print(str);
   }
   ...
   {
      if (on) System.out.println(str);
   }
   public static void P_(String str)
   {
      if (on) System.out.print(str);
   }
